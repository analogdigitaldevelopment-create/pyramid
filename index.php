...
<head>
    ...
    <?php
  $page_title = "Pyramid Group";
  $page_description = "15 years of trusted construction and interior services in Nagpur. Residential and commercial projects.";
...
<body>
    ...
    <section>
        <div class="slider">
            <div class="content">
                <h1>15 Years of Trust, Quality & Timely Delivery</h1>
          ...
          <p>From Foundations to Dreams Your Future Starts with Pyramid Group</p>
            ...
            <div class="box-container">
                <div class="box">
                    <p>We build landmark homes and commercial spaces that reflect innovation and trust.</p>
                </div>
            </div>
    ...
    <div class="ongoingsection">
        <div class="ongoingpro-heading">
            <h2>Completed Projects with possession</h2>
        </div>
        <div class="ongoingpro">
            <div class="ongoingpro-container">
                <div class="ongoingpro-card">
        ...
        <a href="completed.php"><button class="viewmore">View More <i
                    class="ri-arrow-right-double-fill"></i></button></a>
    </div>
    ...
    <section id="need">
        <div class="need">
            <div class="need-row">
                <div class="need-col">
                    <h2>Why <br> <span>Pyramid Group?</span></h2>
                    <div class="need-card">
                        ...
                        <div class="need-content">
                            ...
                            <p>We’ve delivered multiple landmark projects across Nagpur, earning the trust of thousands
                                of families
                                and investors.
                            </p>
                    ...
                    <div class="need-card">
                        ...
                        <div class="need-content">
                            ...
                            <p>Every Pyramid property is strategically located for easy access to schools, hospitals,
                                airports, metro
                ...
                <div class="need-col">
                    <div class="need-card">
                        ...
                        <div class="need-content">
                            ...
                            <p>Our projects are built with the finest materials, advanced techniques, & a strong focus
                                on safety and
                                durability.
                            </p>
                            <a href="about.php"><button>Learn More</button></a>
                    ...
                    <div class="need-card">
                        ...
                        <div class="need-content">
                            ...
                            <p>We are committed to timely possession, with a strong track record of delivering projects
                                within
        ...
        <div class="enquiry">
            <div class="enquiry-container">
                <div class="enquiry-heading">
                    <h2>Find Your Property Today</h2>
                    <p>Ready to buy your dream home or invest in commercial real estate in Nagpur? Use our advanced
                        property
                        search to filter by location, budget, & project type. <br><br> Whether you're searching for
                        residential flats, plots, or commercial spaces, we make it easy to discover the right property
                        for your needs</p>
